...
public static void main(String[] args) {
	...
	driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Mia");
	driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("Testing");
	driver.findElement(By.id("createLeadForm_description")).sendKeys("Assignment 1 - Edit");
	driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("md@gmail.com");
	...
	driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("Testing important update");
	driver.findElement(By.name("submitButton")).click();
