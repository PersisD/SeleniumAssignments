...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Messiah");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Dev");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Messy");
		driver.findElement(By.id("createLeadForm_departmentName")).sendKeys("Testing");
		driver.findElement(By.id("createLeadForm_description")).sendKeys("Assignment 1");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("mz@gmail.com");
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("LTD");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Hanah");
